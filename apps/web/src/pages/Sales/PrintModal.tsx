...
export function PrintModal({ isOpen, onClose, data }: PrintModalProps) {
  ...
  const handlePrintInvoice = useReactToPrint({
    ...
    documentTitle: `Fatura_${data.invoice_number}`,
  });

  const handlePrintReceipt = useReactToPrint({
    contentRef: receiptRef,
    documentTitle: `Fis_${data.invoice_number}`,
  });
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Yazdir" size="lg">
      <div className={styles.container}>
        ...
        <div className={styles.typeSelector}>
          ...
          >
            ...
            <span>A4 Fatura</span>
            <small>Standart fatura formati</small>
          </button>
          <button
          ...
          >
            ...
            <span>Fis (80mm)</span>
            <small>Termal yazici icin</small>
          </button>
        </div>
