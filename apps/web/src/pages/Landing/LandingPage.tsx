...
const planDefs: PlanDef[] = [
  {
    ...
    featureKeys: [
      ...
      { key: 'customerAccount', included: true },
      { key: 'cashAndExpense', included: true },
      ...
      { key: 'renewalTracking', included: false },
      { key: 'crm', included: false },
      { key: 'fieldTeam', included: false },
      { key: 'apiAccessSoon', included: false },
    ],
  },
  {
    key: 'pro',
    ...
    featureKeys: [
      ...
      { key: 'renewalTracking', included: true },
      { key: 'crm', included: false },
      { key: 'fieldTeam', included: false },
      { key: 'apiAccessSoon', included: false },
    ],
  },
  {
    ...
    featureKeys: [
      ...
      { key: 'apiAccessSoon', included: true },
    ],
  },
];
